...
public class UserController {
    ...
    {
        userList.add(new User(1, "jpu01", "user01@test.com", "remine", new Date()));
        userList.add(new User(2, "jpu02", "user02@test.com", "restart", new Date()));
        userList.add(new User(3, "jpu03", "user03@test.com", "nine", new Date()));
        userList.add(new User(4, "jpu04", "user04@test.com", "namu", new Date()));
    }
